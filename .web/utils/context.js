...
export const StateContexts = {
  ...
  reflex___state____state__portubot___state____state: createContext(null),
...
export const lastCompiledTimeStamp = "2025-05-05 15:48:20.521326"
...
export function StateProvider({ children }) {
  ...
  const [reflex___state____state__portubot___state____state, dispatch_reflex___state____state__portubot___state____state] = useReducer(applyDelta, initialState["reflex___state____state.portubot___state____state"])
  ...
  const dispatchers = useMemo(() => {
    return {
      ...
      "reflex___state____state.portubot___state____state": dispatch_reflex___state____state__portubot___state____state,
  ...
  return (
    ...
    <StateContexts.reflex___state____state__portubot___state____state value={ reflex___state____state__portubot___state____state }>
    ...
    </StateContexts.reflex___state____state__portubot___state____state>
